...
public abstract class OPCPackage implements RelationshipSource, Closeable {
    ...
    */
     ...
     *            The output stream use to save this package.
     */
    protected abstract void saveImplEx(OutputStream outputStream)
            throws IOException;
     ...
     * @see #saveImpl(OutputStream)
     */
    public void saveEx(OutputStream outputStream) throws IOException {
        throwExceptionIfReadOnly();
        this.saveImplEx(outputStream);
    }
}
